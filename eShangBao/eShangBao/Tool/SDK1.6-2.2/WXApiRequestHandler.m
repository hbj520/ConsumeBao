...
+ (NSString *)jumpToBizPay:(NSString *)prepayid sign:(NSString * )sign noncestr:(NSString * )noncestr
{
...
//                req.appid               = @"wx503097df712d5a58";
                req.partnerId           = @"1311054701";
