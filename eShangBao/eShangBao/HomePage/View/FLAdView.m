...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        flScroll = [[FLScrollView alloc]initWithFrame:CGRectMake(0, 0, WIDTH, frame.size.height)];
        flScroll.imgDelegate = self;
//        flScroll.contentSize.height=0;
        flScroll.showsVerticalScrollIndicator=NO;
        flScroll.showsHorizontalScrollIndicator=NO;
