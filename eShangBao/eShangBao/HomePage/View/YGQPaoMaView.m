...
- (instancetype)initWithFrame:(CGRect)frame withTitle:(NSString *)title
{
    ...
    if (self) {
        ...
        myLable.text = title;
        myLable.textColor=MAINCHARACTERCOLOR;
        myLable.font = [UIFont systemFontOfSize:12];
//        myLable.backgroundColor = [UIColor orangeColor];
        
        //计算文本的宽度
        CGFloat calcuWidth = [self widthForTextString:title height:labelHeight fontSize:12];
        ...
        if (calcuWidth>frame.size.width) {
            ...
            behindLabel.textColor=MAINCHARACTERCOLOR;
            behindLabel.font = [UIFont systemFontOfSize:12];
