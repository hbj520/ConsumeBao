...
- (id)init
{
    ...
    if (self) {
        ...
        //[pics addObject:@""];
        [self.view setBackgroundColor:RGBACOLOR(249, 249, 249, 1)];
...
-(void)navigationController:(UINavigationController *)navigationController willShowViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    if (navigationController.viewControllers.count>=2) {
        ...
        for (UIView* ii in viewController.view.subviews) {
            // NSLog(@"%@",ii);
            ii.backgroundColor=RGBACOLOR(249, 249, 249, 1);
        }
        
        [[viewController.view.subviews objectAtIndex:0] setFrame:CGRectMake(0, 0, WIDTH, HEIGHT)];
        
        selectedPan=[[UIView alloc] initWithFrame:CGRectMake(0, HEIGHT-H(131), 320, H(131))];
        selectedPan.backgroundColor=[UIColor whiteColor];
        ...
        [tbv setBackgroundColor:RGBACOLOR(249, 249, 249, 1)];
...
{
    textlabel.text=[NSString stringWithFormat:@"当前选中%lu张(最多10张)",pics.count];
