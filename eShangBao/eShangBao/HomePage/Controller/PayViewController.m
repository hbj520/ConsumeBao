...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    {
        NSDictionary * param=@{@"type":@"1",@"minLevel":@""};
        [RequstEngine requestHttp:@"1023" paramDic:param blockObject:^(NSDictionary *dic) {
            ...
            for (NSDictionary * dict in dic[@"categoryList"]) {
                ...
                _levelId=_levelArr[0];
                _price=_priceArr[0];
                
            }
            DMLog(@"__%@,%@",_nameArr,_priceArr);
            [self loadUI];
        }];
...
- (void)viewDidLoad {
    ...
    [self.view addSubview:activityView];
     ...
     DMLog(@"%@,%@,%@,%@",_tuiName,_phone,_idNumber,_etype);
    _Choose=3;
    _licenceImgUrl=@"";
    _allowImgUrl=@"";
...
//    goldLabel.text=_nameArr[0];
//    goldMoneyLabel.text=[NSString stringWithFormat:@"支付金额：￥%@",_priceArr[0]];
//    platinumLabel.text=_nameArr[1];
//    platinumMoneyLabel.text=[NSString stringWithFormat:@"支付金额：￥%@",_priceArr[1]];
//    diamondLabel.text=_nameArr[2];
//    diamondMoneyLabel.text=[NSString stringWithFormat:@"支付金额：￥%@",_priceArr[2]];
 
//        goldLabel.text=@"铂金加盟商";
//        goldMoneyLabel.text=@"支付金额：￥5000";
//        platinumLabel.text=@"钻石加盟商";
//        platinumMoneyLabel.text=@"支付金额：￥10000";
}
...
//    }
    ...
    if (_isSeletect==NO) {
        ...
        [UIAlertView alertWithTitle:@"温馨提示" message:@"请同意万商联盟后再付款" buttonTitle:nil];
    }
    ...
    else
    {
        if (_payStyle==0) {
            DMLog(@"微信支付");
            DMLog(@"___%@\n%@\n%@\n%@\n%@\n%@\n%@\n%@\n%@\n%@\n%@\n%@\n%@",_name,_idcardno,_levelId,_inviteCode,_shopName,_branchName,_branchPhone,_shopAddr,_categoryId,_firstImgArr,_number,_licenceImgUrl,_allowImgUrl);
            
            //whichType  0:成为   1:推荐
            if (_whichPage==0) {
                NSDictionary * param = @{@"name":_name,@"idcardno":_idcardno,@"shopLevel":_levelId,@"payMethod":[NSString stringWithFormat:@"%d",_payStyle],@"inviteCode":_inviteCode,@"payType":[NSString stringWithFormat:@"%d",_payStyle],@"shopName":_shopName,@"branchName":_branchName,@"branchPhone":_branchPhone,@"shopAddr":_shopAddr,@"categoryId":_categoryId,@"doorImg":_firstImgUrl,@"businessNum":_number,@"businessImg":_licenceImgUrl,@"licenseImg":_allowImgUrl,@"startBusinessTime":@"",@"endBusinessTime":@"",@"latitude":_latitude,@"longitude":_longitude,@"startSendPrice":@"",@"sendPrice":@"",@"transitTime":@"",@"sendDistance":@"",@"imgList":@""};
                [RequstEngine requestHttp:@"1025" paramDic:param blockObject:^(NSDictionary *dic) {
                    DMLog(@"1025--%@",dic);
                    DMLog(@"error---%@",dic[@"errorMsg"]);
...
//                        [activityView stopAnimate];
                        ...
                        [RequstEngine requestHttp:@"1059" paramDic:param blockObject:^(NSDictionary *dic) {
                            ...
                            if ([dic[@"errorCode"] intValue]==00000) {
                                ...
                                //发起微信支付，设置参数
                                _accomplishBtn.enabled=YES;
                                [[NSUserDefaults standardUserDefaults] setObject:@"2" forKey:@"types"];
                                [[NSUserDefaults standardUserDefaults] synchronize];
            ...
            {
                DMLog(@"type--%@",_etype);
                NSDictionary * param=@{@"name":_tuiName,@"idcardno":_idNumber,@"partnerLevel":_levelId,@"payMethod":[NSString stringWithFormat:@"%d",_payStyle],@"type":_etype,@"payType":[NSString stringWithFormat:@"%d",_payStyle],@"phone":_phone,@"captcha":@"0",@"loginName":_loginName};
...
//                        [activityView stopAnimate];
        ...
        {
            DMLog(@"线下支付");
            DMLog(@"___%@\n%@\n%@\n%@\n%@\n%@\n%@\n%@\n%@\n%@\n%@",_inviteCode,_shopName,_branchName,_branchPhone,_shopAddr,_categoryId,_firstImgArr,_storeImgArr,_licenceImgUrl,_allowImgUrl,_number);
            if (_whichPage==0) {
                NSDictionary * param = @{@"name":_name,@"idcardno":_idcardno,@"shopLevel":_levelId,@"payMethod":[NSString stringWithFormat:@"%d",_payStyle],@"inviteCode":_inviteCode,@"payType":[NSString stringWithFormat:@"%d",_payStyle],@"shopName":_shopName,@"branchName":_branchName,@"branchPhone":_branchPhone,@"shopAddr":_shopAddr,@"categoryId":_categoryId,@"doorImg":_firstImgUrl,@"businessNum":_number,@"businessImg":_licenceImgUrl,@"licenseImg":_allowImgUrl,@"startBusinessTime":@"",@"endBusinessTime":@"",@"latitude":_latitude,@"longitude":_longitude,@"startSendPrice":@"",@"sendPrice":@"",@"transitTime":@"",@"sendDistance":@"",@"imgList":@""};
                [RequstEngine requestHttp:@"1025" paramDic:param blockObject:^(NSDictionary *dic) {
                    DMLog(@"1025--%@",dic);
        ...
        {
            if (_whichPage==0) {
                NSDictionary * param = @{@"name":_name,@"idcardno":_idcardno,@"shopLevel":_levelId,@"payMethod":@"0",@"inviteCode":[NSString stringWithFormat:@"%@",_inviteCode],@"payType":[NSString stringWithFormat:@"%d",_payStyle],@"shopName":_shopName,@"branchName":_branchName,@"branchPhone":_branchPhone,@"shopAddr":_shopAddr,@"categoryId":_categoryId,@"doorImg":_firstImgUrl,@"businessNum":_number,@"businessImg":_licenceImgUrl,@"licenseImg":_allowImgUrl,@"startBusinessTime":@"",@"endBusinessTime":@"",@"latitude":_latitude,@"longitude":_longitude,@"startSendPrice":@"",@"sendPrice":@"",@"transitTime":@"",@"sendDistance":@"",@"imgList":@""};
                [RequstEngine requestHttp:@"1025" paramDic:param blockObject:^(NSDictionary *dic) {
                    DMLog(@"1025--%@",dic);
                    DMLog(@"error---%@",dic[@"errorMsg"]);
                    if ([dic[@"errorCode"] intValue]==00000) {
...
//                            [[AlipaySDK defaultService] payOrder:orderString fromScheme:appScheme callback:^(NSDictionary *resultDic) {
//                                if ([resultDic[@"resultStatus"] intValue]==9000) {
//                                    NSDictionary * param=@{@"type":@"2",@"orderId":dic[@"orderId"]};
...
//                        }
            ...
            {
                DMLog(@"type--%@",_etype);
                NSDictionary * param=@{@"name":_tuiName,@"idcardno":_idNumber,@"partnerLevel":_levelId,@"payMethod":@"0",@"type":_etype,@"payType":[NSString stringWithFormat:@"%d",_payStyle],@"phone":_phone,@"captcha":@"0",@"loginName":_loginName};
                [RequstEngine requestHttp:@"1028" paramDic:param blockObject:^(NSDictionary *dic) {
                    DMLog(@"1028--%@",dic);
                    DMLog(@"error---%@",dic[@"errorMsg"]);
                    if ([dic[@"errorCode"] intValue]==00000) {
...
//                            [[AlipaySDK defaultService] payOrder:orderString fromScheme:appScheme callback:^(NSDictionary *resultDic) {
//                                if ([resultDic[@"resultStatus"] intValue]==9000) {
//                                    NSDictionary * param=@{@"memberId":USERID,@"orderId":dic[@"orderId"]};
