...
@interface LicenceViewController ()<UIActionSheetDelegate,UIPickerViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UITextFieldDelegate,uploadImageDelegate>
{
...
- (void)viewDidLoad {
    ...
    firstImg.image=[UIImage imageNamed:@"3.jpg"];
    ...
    _imgUrl=_businessImg;
    DMLog(@"imgUrl-----%@,%@",_imgUrl,_businessImg);
...
//        
//        
//        UIView * view=[[UIView alloc]initWithFrame:CGRectMake(W(10)+i*W(60), H(10), W(50), H(50))];
...
//    _addButton.frame=CGRectMake(assets.count*(W(60))+W(10), H(10), W(50), H(50));
//    
//}
//
